...
return(
    ...
    <a href="/"><Image src={logo} alt="yeti logo"className="hover:scale-105 h-20 w-20 ml-5 sm:h-20 sm:w-32 sm:ml-0 sm:p-1 "></Image></a>
    <div className="hidden sm:flex sm:items-center sm:text-1xl sm:space-x-9 sm:text-neutral-100 sm:ml-auto sm:mr-7 font-Orbitron ">
        ...
        <a className="hover:scale-110" href="/gall">Gallery</a>
