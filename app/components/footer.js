...
export default function Footer(){
    return(
      <div className=" bg-stone-800 pt-5 ">  
  <footer className="flex  space-x-2 sm:space-x-9 sm:p-8  pb-5 text-slate-50 ">
    <div className="flex flex-1 text-sm justify-center items-center border-r-2">
      <Image src={logo} alt="yeti logo" className="h-24 w-24"></Image>
    </div>
    <div className="flex-1 text-sm border-r-2">
      <h5>Section</h5>
      <br></br>
      <ul className="">
...
</svg>\<svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="white" class="bi bi-instagram" viewBox="0 0 16 16">
